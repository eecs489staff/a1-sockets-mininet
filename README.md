...
You will be using our VM image ([link here](https://drive.google.com/uc?export=download&id=1G_VOCKQlMsEfzo0xkAtwNJtWNEKA3Wfr)) with Mininet 2.3 pre-installed. Please download and import the VM image into VirtualBox. To transfer files to/from your VM you can use the Shared Folder feature provided in VirtualBox. We will go over this in more detail in discussion.
